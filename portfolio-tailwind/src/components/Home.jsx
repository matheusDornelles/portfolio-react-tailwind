    ...
    return (
        <div name='home' className='w-full h-screen bg-[#0a192f]'>
            ...
            <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
                <p className='text-pink-600'>Olá, meu name é</p>
                ...
                <p className='text-[#8892b0] py-4 max-w-[700px]  '>eu sou um desenvolvedor full-stack especializado em construir sistemas web com REACT, estou focado em
                     construção de aplicativos web full-stack responsivos.</p>
                <div>
